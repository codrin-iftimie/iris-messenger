...
export default {
  ...
  generateName() {
    return (
      this.capitalize(_.sample(adjectives)) +
      " " +
      this.capitalize(_.sample(animals))
    );
  },
    ...
    () => {
      if ($("#message-view")[0]) {
        $("#message-view").scrollTop(
          $("#message-view")[0].scrollHeight -
            $("#message-view")[0].clientHeight
        );
      }
    },
    100,
  ...
  getIdenticon(pub, width) {
    ...
    var identicon = $(
      new iris.Attribute({ type: "keyID", value: pub }).identicon({
        width,
        showType: false,
      })
    );
